...
terminal.println("");
terminal.println("All birds start flying with randomized brains and after 2500 turns (around 40 real-time seconds), birds who managed to eat the most food are reproduced, and their offspring starts the simulation anew.");
terminal.println("");
...
terminal.println("");
terminal.println("(fwiw, this neither a swarm intelligence simulation (as birds don't see each other) nor a boids one (as birds are not hard-coded to find the food) - it's just regular neural network & genetic algorithm magic.)");
terminal.println("");
